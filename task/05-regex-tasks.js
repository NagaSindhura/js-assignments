...
function getRegexForIPv4() {
   ...
   //return /^((\d|\d{2}|[01]\d{2}|2[0-4]\d|25[0-4]).(\d|\d{2}|[01]\d{2}|2[0-4]\d|25[0-4]).(\d|\d{2}|[01]\d{2}|2[0-4]\d|25[0-4]).(\d|\d{2}|[01]\d{2}|2[0-4]\d|25[0-4]))$/;
   return /^((\d|\d{2}|[01]\d{2}|2[0-4]\d|25[0-4]))(\.|$)){4}/;
}
